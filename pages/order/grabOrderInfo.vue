	...
	<view class="gradRecord-content">
			...
			<view class="mt-card">
				<view class="mt-content-box">
					...
					<view class="mt-frbox"><text>车辆类型</text></view>
				</view>
				<view class="mt-content-box">
					<view class="mt-flbox">
						<text class="mtfa mt-weixiu" style="color: #CB8861;"></text>
						<text>派车数量：</text>
					</view>
					<view class="mt-frbox"><text>车辆类型</text></view>
				</view>
				<view class="mt-content-box">
					<view class="mt-flbox">
						<text class="mtfa mt-person" style="color: #CB8861;"></text>
						<text>搬运人数：</text>
					</view>
					<view class="mt-frbox"><text>车辆类型</text></view>
				</view>
				...
				<view class="mt-content-box">
					<view class="mt-flbox">
						<text class="mtfa mt-clocks" style="color: #CB8861;"></text>
						<text>搬家时间：</text>
					</view>
					<view class="mt-frbox"><text>车辆类型</text></view>
				</view>
				<view class="mt-content-box">
					<view class="mt-flbox">
						<text class="mtfa mt-juli" style="color: #CB8861;"></text>
						<text>距离(公里)：</text>
					</view>
					<view class="mt-frbox"><text>车辆类型</text></view>
				</view>
				<view class="mt-content-box">
					<view class="mt-flbox">
						<text class="mtfa mt-jine" style="color: #CB8861;"></text>
						<text>订单金额：</text>
					</view>
					<view class="mt-frbox"><text>车辆类型</text></view>
				</view>
				<view class="mt-content-box">
					<view class="mt-flbox">
						<text class="mtfa mt-fuwufei" style="color: #CB8861;"></text>
						<text>扔单提成：</text>
					</view>
					<view class="mt-frbox"><text>车辆类型</text></view>
				</view>
...
export default {
	...
	methods: {
		...
		payMoney:function(item){ // 发送网络请求
			let robMerchantInfoId = item.robMerchantInfoId
