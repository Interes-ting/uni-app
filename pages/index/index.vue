	...
	<view class="content">
		...
		<view class="page-section swiper">
			<view class="page-section-spacing">
				<swiper class="swiper" indicator-dots="true" autoplay="true" interval="2000" duration="500" indicator-color="#999999"
				 indicator-active-color="#133C8E">
					<swiper-item>
						<view class="swiper-item">
							<image src="../../static/swiper.png"></image>
						</view>
					</swiper-item>
					<swiper-item>
